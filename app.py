...
# Initialize Local Session Caching
...
with tab2:
    ...
    with st.form("compliance_form"):
        ...
        # FIXED LINE HERE:
        submit_btn = st.form_submit_button("Evaluate Compliance Risk Status")
